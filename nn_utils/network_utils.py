...
def create_lstm_network(num_frequency_dimensions, num_hidden_dimensions, num_recurrent_units=1):
	...
	model.add(TimeDistributed(Dense(input_dim=num_frequency_dimensions, output_dim=num_hidden_dimensions), input_shape=(num_frequency_dimensions, num_hidden_dimensions)))
